...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100" x-data="{ open: false }">
            ...
            {{-- Нижнее меню (только для мобилок/планшетов) --}}
            <div class="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50">
                <div class="flex justify-around items-center h-14">
                    <!-- Домой -->
                    <a href="{{ route('home') }}" class="flex flex-col items-center text-gray-600 hover:text-indigo-600">
                    ...
                    <!-- Избранное -->
                    <a href="{{ route('favorites.index') }}" class="flex flex-col items-center text-gray-600 hover:text-pink-500">
                    ...
                    <!-- Корзина -->
                    <a href="{{ route('cart.index') }}" class="flex flex-col items-center text-gray-600 hover:text-indigo-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Профиль -->
                    <a href="{{ route('cabinet') }}" class="flex flex-col items-center text-gray-600 hover:text-indigo-600">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
